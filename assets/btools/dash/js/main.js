    ...
    window.templateCustomizer
      ? (t &&
        ...
        window.Helpers.isLightStyle()
          ...
          : (t && (t.querySelector("i").classList.add("bx-sun"), new bootstrap.Tooltip(t, { title: "Light mode", fallbackPlacements: ["bottom"] })), s("dark")))
    ...
    $(function () {
      ...
      o.length &&
        ...
        a.length &&
          ...
          (o = "search.json"),
          $("#layout-menu").hasClass("menu-horizontal") && (o = "search.json"),
...
if ($('#listNotif')) {
  $.get('/api/notification', function(d) {
    $("#cmsg").html(d.data.length)
    $("#listNotif").html('')
    d.data.forEach(f => {
      $("#listNotif").append(`
        <li class="list-group-item list-group-item-action dropdown-notifications-item">
            <div class="d-flex">
                <div class="flex-shrink-0 me-3">
                    <div class="avatar">
                      <span class="avatar-initial rounded-circle bg-label-${f.background}"><i class="bx bx-${f.icon}"></i></span>
                    </div>
                </div>
                <div class="flex-grow-1">
                    <h6 class="mb-1">${f.subject}</h6>
...
if (localStorage.getItem("myLang")) {
  $('#iconLang').html(`<i class="flag-icon flag-icon-${localStorage.getItem("myLang")} flag-icon-squared rounded-circle fs-3 me-1"></i>`)
}
